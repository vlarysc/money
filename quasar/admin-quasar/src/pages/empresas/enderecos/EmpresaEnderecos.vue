  ...
  <div class="q-pa-xs">
    ...
    <div>
      <div class="q-pa-none q-gutter-sm" style="text-align: right;">
        <q-form>
          ...
          >
            <q-card class="q-pa-none" style="width:600px;height:380px; border-radius: 15px;">
              <q-toolbar>
                <q-header />
              ...
              <q-card-section>
                <EmpresaEnderecoForm :endereco="endereco" @fechar="salvarEndereco"></EmpresaEnderecoForm>
              </q-card-section>
            </q-card>
          </q-dialog>
        </q-form>
    ...
    <q-page-sticky position="bottom-right" :offset="[18, 25]">
      <div class="q-pa-none" style="text-align: right;">
        <q-fab icon="add" class="btnAdd bg-blue-8 text-white" @click="novoendereco()" />
      </div>
    </q-page-sticky>
  </div>
</template>
...
import EmpresaEnderecoForm from "./EmpresaEnderecoForm";

export default {
  components: { EmpresaEnderecoForm },
  computed: {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: "Bairro", label: "Bairro", align: "left", field: "bairro", sortable: true },
        ...
        { name: "option", align: "center", style: "width: 10px", label: "Opções", sortable: false }
      ]
    };
  },

  methods: {
    ...mapActions("empresa", ["addEndereco", "deleteEndereco"]),
