<template>
  <q-layout view="hHh Lpr lff">
    <q-header>
      <q-bar class="ft" style="height: 50px;">
        <q-btn
          v-if="$q.screen.xs"
          flat
          dense
        ...
        <div v-if="!$q.screen.xs" class="btn-header row">
          ...
          <div
            class="avatar text-white rounded-borders row flex-center q-mt-md"
          >
            <q-btn flat size="sm">
              <q-chip size="md" flat>
                <q-avatar>
              ...
              <q-menu>
                <q-list
                  class="foto-logout"
                  style="min-width: 210px; min-height: 200px;"
                >
                  <q-item clickable v-close-popup>
                    <q-item-section
                      ...
                      >
                        <div
                          class="absolute-bottom bg-transparent items-center"
                        >
      ...
      >
        <div class="absolute-bottom bg-transparent items-center">
          ...
          <div class="row rounded-borders">
            {{ user ? user.email : "email" }}<q-space /><q-btn
              @click="sair()"
              outline
              size="sm"
              >Sair</q-btn
    ...
    <q-footer class="pe q-my-xs bg-indigo" style="height: 15px; ">
      <div style="padding-top: none" class="ft q-pl-md row">
          ...
          >
            <template>
              <div style="width:300px;height:320px;">
                ...
                />
                <q-btn class="btn-note" v-close-popup @click="persist"
                  >Salvar</q-btn
                >
              </div>
            </template>
          ...
          >
            <template>
              <div style="width:300px;height:320px;">
                ...
                />
                <q-btn class="btn-note" @click="persist" v-close-popup
                  >Salvar</q-btn
                >
              </div>
            </template>
        ...
        <div class="status q-pa-none q-mt-xs  col-5">
          <q-spinner color="amber" size="1em" :thickness="10" />
          <strong> Meu </strong>
